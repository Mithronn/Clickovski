...
const SvgPorteguese = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g transform="translate(0 26.7)scale(1.06667)">
      ...
      />
      <g id="Porteguese_svg__e">
        <g id="Porteguese_svg__d" fill="#ff0" stroke="#000" strokeWidth={0.5}>
          <path
            stroke="none"
          ...
          <path id="Porteguese_svg__a" d="M191 141.6v3.4h-4v-3.4z" />
          <use
            xlinkHref="#Porteguese_svg__a"
            width="100%"
            height="100%"
            x={10.6}
          />
          <path
            id="Porteguese_svg__b"
            d="M186.3 139h1.2v1h.9v-1h1.2v1h.9v-1h1.2v2q0 .6-.5.6h-4.3l-.6-.6z"
          />
          <use
            xlinkHref="#Porteguese_svg__b"
            width="100%"
            height="100%"
            x={10.6}
          />
          ...
          />
          <path
            id="Porteguese_svg__c"
            fill="#000001"
            stroke="none"
            d="M188.6 142.8c0-.6.8-.6.8 0v1.2h-.8z"
          />
          <use
            xlinkHref="#Porteguese_svg__c"
            width="100%"
            height="100%"
            x={10.6}
          />
      ...
      <use xlinkHref="#Porteguese_svg__d" width="100%" height="100%" x={45.7} />
      <use
        xlinkHref="#Porteguese_svg__e"
        width="100%"
        height="100%"
        transform="matrix(-1 0 0 1 479.8 0)"
      />
      <g id="Porteguese_svg__f" fill="#fff">
        <path
          fill="#039"
      ...
      <use xlinkHref="#Porteguese_svg__f" width="100%" height="100%" y={-26} />
      <use
        xlinkHref="#Porteguese_svg__f"
        width="100%"
        height="100%"
        x={-20.8}
      />
      <use xlinkHref="#Porteguese_svg__f" width="100%" height="100%" x={20.8} />
      <use xlinkHref="#Porteguese_svg__f" width="100%" height="100%" y={25.8} />
    </g>
  </svg>
);
export default SvgPorteguese;
