...
export const setStarting = (payload) => (dispatch) =>
  dispatch({ type: types.STARTING, payload: { isStarting: payload } });

export const startLauncher = () => (dispatch) =>
  dispatch({ type: types.START, payload: { isStarted: true } });

export const stopLauncher = () => (dispatch) =>
...
export const setDelay = (payload) => (dispatch) =>
...
export const setKey = (payload) => (dispatch) =>
  dispatch({ type: types.KEY, payload: { isKey: payload } });

export const setKeyType = (payload) => (dispatch) =>
  dispatch({ type: types.KEYTYPE, payload: { isKeyType: payload } });

export const setGlobalShortcutActive = (payload) => (dispatch) =>
  dispatch({
    type: types.GLOB_SHOR_AC,
    payload: { isGlobalShortcutActive: payload },
  });

export const setGlobalShortcut = (payload) => (dispatch) =>
